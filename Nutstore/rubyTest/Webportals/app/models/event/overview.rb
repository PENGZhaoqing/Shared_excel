...
class Event < ActiveRecord::Base
  class Overview
    def today
      Event.within_dates(today_date, tomorrow_date)
    end

    def tomorrow
      Event.within_dates(tomorrow_date, after_tomorrow_date)
    end

    def later
      Event.within_dates(after_tomorrow_date, future_cutoff_date)
    end
